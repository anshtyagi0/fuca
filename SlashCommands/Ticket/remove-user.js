    ...
    run: async (client, interaction) => {
        ...
        try {
            ...
            if (interaction.member.permissions.has("ManageRoles") || interaction.member.permissions.has("Administrator")) {
                ...
                await interaction.guild.channels.cache.get(channel).permissionOverwrites.delete(user)
                interaction.editReply({ content: 'Removed user.' })
            } else {
            ...
            const msg = new webhook.MessageBuilder()
                ...
                .setDescription(`ERROR IN REMOVE USER TICKET COMMAND.\n${err}`)
                .setColor('#000')
